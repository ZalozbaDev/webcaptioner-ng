...
echo "REACT_APP_RECORDING_INFORMATION_LINE=$REACT_APP_RECORDING_INFORMATION_LINE"   >> .env
echo "REACT_APP_DEFAULT_AUDIO_FORMAT=$REACT_APP_DEFAULT_AUDIO_FORMAT"               >> .env
echo "REACT_APP_DEFAULT_TRANSLATION_TARGET_LANGUAGE=$REACT_APP_DEFAULT_TRANSLATION_TARGET_LANGUAGE" >> .env
